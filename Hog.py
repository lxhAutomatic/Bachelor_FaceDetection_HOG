...
img = cv.imread('test_img.jpg', cv.IMREAD_GRAYSCALE)
img = cv.resize(img,dsize=(200,200),interpolation=cv.INTER_LINEAR )
#自定义参数
hog = Hog_descriptor(img, cell_width=16, block_width=3, bin_size=8, block_stride=1)
#默认参数
